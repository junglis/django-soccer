# Based on James Bennett's user-profile
"""
...
#from django.views.generic.list_detail import object_list #appears to be deprecated

from user_profile import utils
from user_profile.models import Player
from user_profile.forms import ProfileForm
from registration.views import RegistrationView as BaseRegistrationView
################### copied from the view that lets you register
class ProfileView(BaseRegistrationView):
    form_class = ProfileForm #'email_auth.forms.RegistrationForm'
    success_url = None
    template_name = 'user_profile/profile_form.html'
    #import pdb; pdb.set_trace()

def create_profile(self, request, **cleaned_data):
  """
  Given a team name and the players on it, create a new profile.
  ...
  #                              user=new_user,
  #                              request=request)
  return team_name # not sure why the team name should be returned
...
def edit_profile(request, form_class=None, success_url=None,
                 template_name='user_profiles/edit_profile.html',
                 extra_context=None):
  pass
...
#     """
#     try:
#         player_obj = Player.objects.get(User=User)
#         return HttpResponseRedirect(reverse('user_profiles_edit_profile'))
...
#         success_url = reverse('user_profiles_profile_detail',
...
#     except ObjectDoesNotExist:
#         return HttpResponseRedirect(reverse('user_profiles_create_profile'))
